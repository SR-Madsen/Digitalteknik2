...
HD_PWD='C:/Xilinx/Projekter/Calculator_Lab8/Calculator_Lab8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Calculator_toplevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Calculator_toplevel.tcl -notrace
