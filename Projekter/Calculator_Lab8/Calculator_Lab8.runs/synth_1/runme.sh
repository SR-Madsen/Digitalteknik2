...
HD_PWD='C:/Xilinx/Projekter/Calculator_Lab8/Calculator_Lab8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Calculator_toplevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Calculator_toplevel.tcl
