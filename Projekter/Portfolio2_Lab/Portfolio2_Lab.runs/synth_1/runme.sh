...
HD_PWD='C:/Xilinx/Projekter/Portfolio2_Lab/Portfolio2_Lab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MiniGames_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MiniGames_Top.tcl
