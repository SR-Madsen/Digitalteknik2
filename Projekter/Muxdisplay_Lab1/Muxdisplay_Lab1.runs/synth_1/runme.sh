...
HD_PWD='C:/Xilinx/Projekter/Muxdisplay_Lab1/Muxdisplay_Lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Muxdisp_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Muxdisp_Top.tcl
