...
HD_PWD='C:/Xilinx/Projekter/Muxdisplay_Lab1/Muxdisplay_Lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Muxdisp_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Muxdisp_Top.tcl -notrace
