...
HD_PWD='C:/Xilinx/Projekter/Test_projekt/Test_projekt.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Test_design.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Test_design.tcl -notrace
