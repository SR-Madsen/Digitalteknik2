...
HD_PWD='C:/Xilinx/Projekter/Test_projekt/Test_projekt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Test_design.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Test_design.tcl
