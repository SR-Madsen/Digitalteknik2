...
HD_PWD='C:/Xilinx/Projekter/Scope_Lab9/Scope_Lab9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ScopeDesign_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ScopeDesign_wrapper.tcl
