...
HD_PWD='C:/Xilinx/Projekter/Scope_Lab9/Scope_Lab9.runs/ScopeDesign_MuxDisplay_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ScopeDesign_MuxDisplay_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ScopeDesign_MuxDisplay_0_1.tcl
