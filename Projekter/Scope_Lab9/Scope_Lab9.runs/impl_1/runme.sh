...
HD_PWD='C:/Xilinx/Projekter/Scope_Lab9/Scope_Lab9.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ScopeDesign_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ScopeDesign_wrapper.tcl -notrace
