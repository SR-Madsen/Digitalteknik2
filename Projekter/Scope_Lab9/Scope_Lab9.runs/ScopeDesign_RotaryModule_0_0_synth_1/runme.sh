...
HD_PWD='C:/Xilinx/Projekter/Scope_Lab9/Scope_Lab9.runs/ScopeDesign_RotaryModule_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ScopeDesign_RotaryModule_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ScopeDesign_RotaryModule_0_0.tcl
