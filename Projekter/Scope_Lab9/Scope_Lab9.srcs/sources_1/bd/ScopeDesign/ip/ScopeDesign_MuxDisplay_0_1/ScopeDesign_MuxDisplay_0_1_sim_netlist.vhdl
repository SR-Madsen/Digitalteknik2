...
--               c:/Xilinx/Projekter/Scope_Lab9/Scope_Lab9.srcs/sources_1/bd/ScopeDesign/ip/ScopeDesign_MuxDisplay_0_1/ScopeDesign_MuxDisplay_0_1_sim_netlist.vhdl
...
entity ScopeDesign_MuxDisplay_0_1_MuxDisplay is
  port (
    dp : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of ScopeDesign_MuxDisplay_0_1_MuxDisplay : entity is "MuxDisplay";
end ScopeDesign_MuxDisplay_0_1_MuxDisplay;

architecture STRUCTURE of ScopeDesign_MuxDisplay_0_1_MuxDisplay is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ScopeDesign_MuxDisplay_0_1 is
  port (
    Clk_100MHz : in STD_LOGIC;
    HexCifre : in STD_LOGIC_VECTOR ( 15 downto 0 );
    dpoints : in STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute NotValidForBitStream of ScopeDesign_MuxDisplay_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of ScopeDesign_MuxDisplay_0_1 : entity is "ScopeDesign_MuxDisplay_0_1,MuxDisplay,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of ScopeDesign_MuxDisplay_0_1 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of ScopeDesign_MuxDisplay_0_1 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of ScopeDesign_MuxDisplay_0_1 : entity is "MuxDisplay,Vivado 2019.1";
end ScopeDesign_MuxDisplay_0_1;

architecture STRUCTURE of ScopeDesign_MuxDisplay_0_1 is
begin
U0: entity work.ScopeDesign_MuxDisplay_0_1_MuxDisplay
     port map (
