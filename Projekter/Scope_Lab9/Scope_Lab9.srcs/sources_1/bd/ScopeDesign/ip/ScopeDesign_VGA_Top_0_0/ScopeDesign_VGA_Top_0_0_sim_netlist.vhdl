...
--               c:/Xilinx/Projekter/Scope_Lab9/Scope_Lab9.srcs/sources_1/bd/ScopeDesign/ip/ScopeDesign_VGA_Top_0_0/ScopeDesign_VGA_Top_0_0_sim_netlist.vhdl
...
entity ScopeDesign_VGA_Top_0_0_VGA_Top is
  port (
  ...
  attribute ORIG_REF_NAME of ScopeDesign_VGA_Top_0_0_VGA_Top : entity is "VGA_Top";
end ScopeDesign_VGA_Top_0_0_VGA_Top;

architecture STRUCTURE of ScopeDesign_VGA_Top_0_0_VGA_Top is
...
entity ScopeDesign_VGA_Top_0_0 is
  ...
  attribute NotValidForBitStream of ScopeDesign_VGA_Top_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of ScopeDesign_VGA_Top_0_0 : entity is "ScopeDesign_VGA_Top_0_0,VGA_Top,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of ScopeDesign_VGA_Top_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of ScopeDesign_VGA_Top_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of ScopeDesign_VGA_Top_0_0 : entity is "VGA_Top,Vivado 2019.1";
end ScopeDesign_VGA_Top_0_0;

architecture STRUCTURE of ScopeDesign_VGA_Top_0_0 is
...
begin
  ...
  \^hsync\ <= Hsync;
  \^vsync\ <= Vsync;
U0: entity work.ScopeDesign_VGA_Top_0_0_VGA_Top
     port map (
      Blank => Blank,
