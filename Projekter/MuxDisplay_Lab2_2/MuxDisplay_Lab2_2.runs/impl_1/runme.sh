...
HD_PWD='C:/Xilinx/Projekter/MuxDisplay_Lab2_2/MuxDisplay_Lab2_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MuxDisplay_V3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MuxDisplay_V3.tcl -notrace
