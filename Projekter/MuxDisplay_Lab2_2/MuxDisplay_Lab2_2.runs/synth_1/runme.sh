...
HD_PWD='C:/Xilinx/Projekter/MuxDisplay_Lab2_2/MuxDisplay_Lab2_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MuxDisplay_V3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MuxDisplay_V3.tcl
