...
HD_PWD='C:/Xilinx/Projekter/Watch_Lab3/Watch_Lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Watch_demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Watch_demo.tcl
