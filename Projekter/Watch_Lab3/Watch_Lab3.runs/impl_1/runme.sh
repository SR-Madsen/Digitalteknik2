...
HD_PWD='C:/Xilinx/Projekter/Watch_Lab3/Watch_Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Watch_demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Watch_demo.tcl -notrace
