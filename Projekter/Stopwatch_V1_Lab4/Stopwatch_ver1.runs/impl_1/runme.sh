...
HD_PWD='C:/Xilinx/Projekter/Stopwatch_V1_Lab4/Stopwatch_ver1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopLevel_StopWatch_v1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopLevel_StopWatch_v1.tcl -notrace
