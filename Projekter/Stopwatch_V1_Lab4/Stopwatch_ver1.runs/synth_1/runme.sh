...
HD_PWD='C:/Xilinx/Projekter/Stopwatch_V1_Lab4/Stopwatch_ver1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopLevel_StopWatch_v1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopLevel_StopWatch_v1.tcl
