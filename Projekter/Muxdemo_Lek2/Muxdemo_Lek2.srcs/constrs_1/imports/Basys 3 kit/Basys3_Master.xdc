...
# Switches
set_property -dict { PACKAGE_PIN V17    IOSTANDARD LVCMOS33 } [get_ports {S_0}]					
set_property -dict { PACKAGE_PIN V16    IOSTANDARD LVCMOS33 } [get_ports {S_1}]					
set_property -dict { PACKAGE_PIN W16    IOSTANDARD LVCMOS33 } [get_ports {D_0[0]}]					
set_property -dict { PACKAGE_PIN W17    IOSTANDARD LVCMOS33 } [get_ports {D_0[1]}]					
set_property -dict { PACKAGE_PIN W15    IOSTANDARD LVCMOS33 } [get_ports {D_1[0]}]					
set_property -dict { PACKAGE_PIN V15    IOSTANDARD LVCMOS33 } [get_ports {D_1[1]}]					
