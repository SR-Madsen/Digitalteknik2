...
HD_PWD='C:/Xilinx/Projekter/Muxdemo_Lek2/Muxdemo_Lek2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MegaMux_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MegaMux_wrapper.tcl -notrace
