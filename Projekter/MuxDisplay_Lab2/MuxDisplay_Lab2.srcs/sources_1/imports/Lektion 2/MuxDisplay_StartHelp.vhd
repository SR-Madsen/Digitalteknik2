...
architecture Behavioral of MuxDisplay_StartHelp is
	...
	signal abcdefg: STD_LOGIC_VECTOR (6 downto 0); -- & Decimal Point
...
begin
   ------------- Please use your decoder here -----------------------
	U1: Hex27Segment PORT MAP( Hex => Hex, LED => abcdefg);
...
--	end process;
   ...
   ScaleProcess: PROCESS( Clk, Sw)
		variable Scale_count: integer range 0 to 100000000 := 0;
		...
		constant x10MHz: 		integer  := 100000000/10000000; -- For simulation		
	begin
