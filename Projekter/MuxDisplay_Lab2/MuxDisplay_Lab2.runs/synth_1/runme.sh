...
HD_PWD='C:/Xilinx/Projekter/MuxDisplay_Lab2/MuxDisplay_Lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MuxDisplay_StartHelp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MuxDisplay_StartHelp.tcl
