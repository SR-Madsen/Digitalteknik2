...
HD_PWD='C:/Xilinx/Projekter/MuxDisplay_Lab2/MuxDisplay_Lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MuxDisplay_StartHelp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MuxDisplay_StartHelp.tcl -notrace
