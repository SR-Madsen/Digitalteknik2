...
HD_PWD='C:/Xilinx/Projekter/MiniGames_Lab10/MiniGames_Lab10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MiniGame_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MiniGame_Top.tcl
