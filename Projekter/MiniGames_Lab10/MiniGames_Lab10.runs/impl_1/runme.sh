...
HD_PWD='C:/Xilinx/Projekter/MiniGames_Lab10/MiniGames_Lab10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MiniGame_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MiniGame_Top.tcl -notrace
