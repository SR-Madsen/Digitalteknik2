...
HD_PWD='C:/Xilinx/Projekter/Portfolio2_Lab/Portfolio2_Lab.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MiniGames_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MiniGames_Top.tcl -notrace
